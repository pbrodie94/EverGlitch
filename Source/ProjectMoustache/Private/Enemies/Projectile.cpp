...
void AProjectile::BeginPlay()
{
	...
	//CollisionSphere->OnComponentBeginOverlap.(this, &AProjectile::OnHit);
...
{
	//Use this area to apply damage to the player or other enemies if we are including friendly fire
